...
const firebaseConfig = {
  ...
  firestoreDatabaseId: cleanEnvValue(import.meta.env.VITE_FIREBASE_DATABASE_ID),
...
// Using initializeFirestore with experimentalForceLongPolling to prevent "Listen stream errored" in proxied environments
