...
const Sidebar = () => {
  ...
  const menuItems = [
    ...
    { icon: MessageSquare, label: 'Expert Synthesis', path: '/chat' },
  ];
  ...
  return (
    <header className="h-16 bg-white/80 backdrop-blur-md border-b border-slate-200 px-8 flex items-center justify-between sticky top-0 z-40">
      <div className="flex items-center gap-4">
        <button className="lg:hidden p-2 hover:bg-slate-100 rounded-lg"><Menu className="w-5 h-5 text-slate-500" /></button>
        <h2 className="text-sm font-semibold text-slate-400 uppercase tracking-widest flex items-center gap-2">
          Platform Core / <span className="text-slate-800">Expert Ops Hub</span>
        </h2>
      </div>
